...
def predict_fn(input_data, model):
    ...
    #input_data_to_words_list = list()
    #input_data_to_words_list.append(input_data_to_words)
    #data_X, data_len = convert_and_pad_data(model.word_dict, input_data_to_words_list)
